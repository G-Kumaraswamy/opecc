import { ENV, envReady } from './js/utils/env.js';
await envReady;
...
const CONFIG = {
  // Gemini API
  GEMINI_API_KEY: ENV.VITE_GEMINI_API_KEY || 'YOUR_GEMINI_API_KEY_HERE',
  GEMINI_MODEL: 'gemini-3-flash-preview',
  GEMINI_ENDPOINT: 'https://generativelanguage.googleapis.com/v1beta/models',

  // Tavus API
  TAVUS_API_KEY: ENV.VITE_TAVUS_API_KEY || 'YOUR_TAVUS_API_KEY_HERE',
